<template>
  <div>
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="位置">
          <el-input v-model="searchInfo.area_location" placeholder="搜索条件" />
        </el-form-item>
        <el-form-item>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="名称" prop="area_name" width="120" />
        <el-table-column align="left" label="位置" prop="area_location" width="120" />
        <el-table-column align="left" label="风险等级" prop="area_risk_level" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.area_risk_level,area_risk_levelOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="text" icon="edit" size="small" class="table-button" @click="updateAreaFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" label-width="80px">
        ...
        <el-form-item label="位置:">
          <el-input v-model="formData.area_location" clearable placeholder="请输入" />
        </el-form-item>
        <el-form-item label="风险等级:">
          <el-select v-model="formData.area_risk_level" placeholder="请选择" style="width:100%" clearable>
            <el-option v-for="(item,key) in area_risk_levelOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
      </el-form>
      <template #footer>
