<template>
  <div>
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="性别">
          <el-input v-model="searchInfo.student_gender" placeholder="搜索条件" />
        </el-form-item>
        <el-form-item label="联系方式">
          <el-input v-model="searchInfo.student_phone_number" placeholder="搜索条件" />
        </el-form-item>
        <el-form-item>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="姓名" prop="student_name" width="120" />
        <el-table-column align="left" label="性别" prop="student_gender" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.student_gender,genderOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="联系方式" prop="student_phone_number" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="text" icon="edit" size="small" class="table-button" @click="updateStudentFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" label-width="80px">
        ...
        <el-form-item label="性别:">
          <el-select v-model="formData.student_gender" placeholder="请选择" style="width:100%" clearable>
